...
When you specify an encoding type, say that you want to encode an integer as a string, that will also be represented in our generated SDKs. Boolean properties can be encoded as strings the same way.
